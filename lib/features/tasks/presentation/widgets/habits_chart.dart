  ...
  Widget build(BuildContext context) {
    ...
    final List<_HabitProgress> habitProgresses = widget.habits.map((h) {
      ...
      if (h['icon_name'] != null) {
         ...
         if (codePoint != null) icon = IconData(codePoint, fontFamily: 'MaterialIcons');
      }
            ...
            children: [
              Text(
                ...
                style: GoogleFonts.cairo(
                  ...
                  color: AppStyle.isDark(context) ? Colors.white : Colors.black87,
                ),
              ),
              Text(
                "آخر 7 أيام",
              ...
              SizedBox(
                ...
                child: CustomPaint(
                  painter: _SegmentedRingPainter(
                    ...
                    trackColor: AppStyle.isDark(context) ? const Color(0xFF2C2C2C) : Colors.grey[200]!,
                      ...
                      children: [
                         Text(
                          ...
                          style: GoogleFonts.outfit(
                            fontSize: 28,
                            fontWeight: FontWeight.bold,
                            color: AppStyle.isDark(context) ? Colors.white : Colors.black,
                          ),
                        ),
                    ...
                    Row(
                       ...
                       children: [
                          ...
                          Text(
                            ...
                            style: GoogleFonts.cairo(fontSize: 10, color: Colors.grey, fontWeight: FontWeight.bold), // Reverted to Grey
                          ),
                       ],
                    ),
                  ],
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    color: isSelected 
                      ...
                      : (AppStyle.isDark(context) ? const Color(0xFF2C2C2C) : Colors.white),
                    borderRadius: BorderRadius.circular(20),
                    border: isSelected ? Border.all(color: item.color, width: 2) : Border.all(color: Colors.transparent, width: 2),
                    boxShadow: [
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: GoogleFonts.cairo(
                          fontSize: 12,
                          fontWeight: FontWeight.bold,
                          color: isSelected ? item.color : (AppStyle.isDark(context) ? Colors.white70 : Colors.black54),
                        ),
                      ),
...
class _HabitProgress {
  ...
  _HabitProgress({required this.title, required this.progress, required this.color, required this.icon});
}
...
class _SegmentedRingPainter extends CustomPainter {
  ...
  _SegmentedRingPainter({required this.segments, required this.trackColor, required this.selectedIndex});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < count; i++) {
      ...
      if (segment.progress > 0) {
        progressPaint.color = isSelected ? segment.color : segment.color.withOpacity(0.8);
        progressPaint.strokeWidth = isSelected ? strokeWidth + 4 : strokeWidth; // Pop out
  ...
  bool shouldRepaint(covariant _SegmentedRingPainter oldDelegate) {
    return oldDelegate.selectedIndex != selectedIndex || oldDelegate.segments != segments;
  }
}
